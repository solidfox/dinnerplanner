...
{
        const bodyOnline = [ <article className="no-menu" id="welcome-view">
        ...
        const bodyOffline = [    <article className="no-menu" id="welcome-view">
            <h3 className="spacious">Welcome to Dinner Planner of Group 5.</h3>
            <h4 className="spacious error">⚠️ Error! No connection found. <br/><br/>If you proceed with DinnerPlanner, <br/>
